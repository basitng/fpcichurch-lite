...
ALLOWED_HOSTS = ["https://fpcichurch.org", "127.0.0.1", "web-production-5569.up.railway.app","https://web-production-5569.up.railway.app"]
CSRF_TRUSTED_ORIGINS=["https://web-production-5569.up.railway.app"]
